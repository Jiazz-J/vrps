create or replace procedure insertall(empid in workdetails.empid%type,designation in workdetails.designation%type,
...
appliedjob in workdetails.appliedjob%type,skills in workdetails.skills%type) as
begin
